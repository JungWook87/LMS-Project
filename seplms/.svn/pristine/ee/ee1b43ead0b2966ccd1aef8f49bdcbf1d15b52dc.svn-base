...
public interface LecDao {
	 ...
	 * @author 김정욱
	 */
	int closeLecOneTbLec(Map<String, Object> paramMap) throws Exception;
	 ...
	 * @author 김정욱
	 */
	int closeLecOneTbAppList(Map<String, Object> paramMap) throws Exception;
	 ...
	 * @author 김정욱
	 */
	int closeLecOneTbClsRoom(Map<String, Object> paramMap) throws Exception;


	List<Map<String, Object>> endLecList() throws Exception;
