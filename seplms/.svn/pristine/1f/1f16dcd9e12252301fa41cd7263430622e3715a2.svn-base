...
public class LecPlanController {
	 ...
	 */
	@ResponseBody
	@RequestMapping("findLecListVue.do")
	public Map<String, Object> findLecListVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".findLecListVue");
		logger.info("   - paramMap : " + paramMap);
		...
		logger.info("+ end " + className + ".findLecListVue");
	 ...
	 */
	@ResponseBody
	@RequestMapping("findWeeklyListVue.do")
	public Map<String, Object> findWeeklyListVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".findWeeklyListVue");
		logger.info("   - paramMap : " + paramMap);
		...
		returnMap.put("weeklyList", weeklyList);
		returnMap.put("preWeeklySize", weeklyList.size());
		
		logger.info("+ end " + className + ".findWeeklyListVue");
	 ...
	 */
	@ResponseBody
	@RequestMapping("saveLecPlanVue.do")
	public Map<String, Object> saveLecPlanVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".saveLecPlanVue");
		logger.info("   - paramMap : " + paramMap);
		
		String msg = lecPlanService.saveLecPlanVue(paramMap);
		
		Map<String, Object> returnMap = new HashMap<>();
		
		returnMap.put("msg", msg);
		
		logger.info("+ end " + className + ".saveLecPlanVue");
