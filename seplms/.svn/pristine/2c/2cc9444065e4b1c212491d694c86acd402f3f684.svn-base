...
public class FileInfoModel {
	...
	private String lec_file_uuid_nm;			// uuid 적용 파일명
	...
	public String getLec_file_uuid_nm() {
		return lec_file_uuid_nm;
	}
	public void setLec_file_uuid_nm(String lec_file_uuid_nm) {
		this.lec_file_uuid_nm = lec_file_uuid_nm;
	}
