...
<script type="text/javascript">
                      ...
                      for(var i=0; i<returndata.studentlist.length; i++){
                         ...
                         var   app_yn = returndata.studentlist[i].app_yn;
                          ...
                          if(app_yn =='Y'){
                             ...
                             html+='<td><a class="btnType blue" href="javascript:possibleYN(\'' + returndata.studentlist[i].loginID + '\');" name="modal"><span>취소</span></a></td>';
   ...
   function possibleYN(data){
	   ...
	   var listcallback = function(returndata){
		   ...
		   if(returndata > 0){
			   ...
			   swal("이미 수강이 시작된 강의입니다 수강거절 할 수 없습니다")
		   }
   ...
   function fn_app_yes(data){
     ...
     /* 수강신청 취소 */    
     function   fn_app_No(data){ //data 뺌
