...
<script type="text/javascript">
	...
	function fn_searchList(){
	   ...
	   var listcallback = function(returndata) {
		...
		callAjax("lmFindWeeklyList.do", "post", "text", true, param, listcallback);
	}
		...
		var listcallback = function(data){
			...
			if(data.lec_file_nm == "" || data.lec_file_nm == null) {
        		...
        		insertHtml = "<a href='javascript:fn_download()'> "
         	    ...
         	    if(lec_file_extend.toLowerCase() == "jpg" ||  lec_file_extend.toLowerCase() == "png"  ||  lec_file_extend.toLowerCase() == "gif" ) {
