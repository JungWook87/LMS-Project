...
<script type="text/javascript">
	...
	function initPop(data){
		...
		$("#score").val(data.score).attr("readonly", true).css("background-color", "#f0f0f0");
						...
						<p class="conTitle">
							...
							<span class="fr"> 
								<select id="searchSel" name="searchSel">
							         ...
							         <option value="stdName">담당교수</option>
							    </select>
				...
				<table class="row">
					...
					<tbody>
						...
						<tr>
							...
							<td >
							<input type="text" class="inputTxt p100" name="score" id="score" />
							</td>
							<th scope="row">상담자 </th>
							<td >
