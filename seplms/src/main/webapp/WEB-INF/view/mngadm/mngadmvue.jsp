		...
		showArea = new Vue({
			...
			methods : {
				fnShow : function(event){
					...
					if(eventTargetID == 'ingLec'){
						this.show = 'N';
						lecpop.lecState = false;
						lecpop.btnSaveShow = true;
						lecpop.btnDeleteShow = true;
					} else{
						this.show = 'Y';
						lecpop.lecState = true;
						lecpop.btnSaveShow = false;
				...
				<table class="row">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text" class="inputTxt p100" name="lec_nm" id="lec_nm" v-model="lec_nm" autocomplete="off" :readonly="lecState"/>
							</td>
						</tr>
						<tr>
							<th scope="row">대상자 <span class="font_red">*</span> </th>
							<td>
								<select style=width:100%; id="lec_ctg" name="lec_ctg" v-model="lec_ctg" :disabled="lecState">
						...
						<tr>
							...
							<td>
					      		<input type="text" class="inputTxt p100" name="capacity" id="capacity" v-model="capacity" placeholder="숫자만 입력하세요." autocomplete="off" :readonly="lecState"/>
							</td>
						</tr>
						<tr>
							<th scope="row">강사명 <span class="font_red">*</span></th>
							<td>
								<select style=width:100% id="loginID" name="loginID" v-model="loginID" :disabled="lecState">
						...
						<tr>
							...
							<td>
								<select style=width:100% id="cls_room" name="cls_room" v-model="cls_room" :disabled="lecState">
						...
						<tr>
							...
							<td>
								<input type="text" class="inputTxt p100" name="lec_days" id="lec_days" v-model="lec_days" placeholder="숫자만 입력하세요." autocomplete="off" :readonly="lecState"/>
							</td>
						</tr>
						<tr>
							<th>시작일자 <span class="font_red">*</span></th>
							<td>
								<input type="date" class="inputTxt p100" name="lec_start_date" id="lec_start_date" v-model="lec_start_date" style="font-size: 15px;" :readonly="lecState"/>
							</td>
						</tr>
						<tr>
							<th>종료일자 <span class="font_red">*</span></th>
							<td>
								<input type="date" class="inputTxt p100" name="lec_end_date" id="lec_end_date" v-model="lec_end_date" style="font-size: 15px;" :readonly="lecState"/>
							</td>
						</tr>
					</tbody>
				</table>
