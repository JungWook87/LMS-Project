...
////////////////////////////////////강의내용 팝업모달/////////////////////////////////////////////////////////
    ...
    function fnPopUpIntLec(data) {
    	...
    	$("#lec_nm").text(data.lec_nm); // 강의 코드
    	$("#lec_ctg").text(data.lec_ctg); // 강의명
    	$("#ins_nm").text(data.ins_nm); // 강사명
    	$("#cls_room").text(data.cls_room); // 강의실
    	$("#ins_email").text(data.ins_email); // 이메일
    	$("#ins_hp").text(data.ins_hp); // 연락처
    	$("#lec_goal").text(data.lec_goal); // 수업 목표
