...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<c:if test="${totalCnt > 0 }">
			...
			<c:forEach items="${listStd}" var="list">
				<tr>
					    ...
					    <td>${list.ing_yn}</td>
						<td><a class="btnType3 color1" href="javascript:fnListStdLec(1,'${list.loginID}');"><span>수강이력보기</span></a></td>
						<%-- javascript:fnStatus('${list.loginID}','${list.status_yn}') --%>
