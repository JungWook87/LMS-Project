...
/* 			
    ...
    function fnPopUpInt(data) {
    	...
    	if(data == null || data == undefined || data == "") {
    		...
    		if(data.sm_file_nm == "" || data.sm_file_nm == null) {
    			inhtml += "";
    		} else {
    			if(data.sm_file_extend == "jpg" || data.sm_file_extend == "png" || data.sm_file_extend == "gif" || data.sm_file_extend == "jpeg") {
    				inhtml += "<img src='" + data.sm_file_logicalpath + "'  style='width: 100px; height: 100px;' />";
				} else {
					//console.log("이미지 파일 아님 : " + data.sm_file_nm);
					inhtml += data.sm_file_nm;
				}
    		}
    		
    		inhtml += "</a>";
    		
    		noticePop.previewhtml = inhtml;
	...
	function fnSave() {
    	...
    	fileData.append("action", noticePop.action); 
    	fileData.append("brd_no", noticePop.selnoticecd); 
    	...
    	callAjaxFileUploadSetFormData("/notice/noticeSavefile.do", "post", "json", true, fileData, saveCallBack);
    }
    ...
    function fn_download() {
    	...
    	var params = "";
    	params += "<input type='hidden' id='brd_no' name='brd_no' value='"+ noticePop.selnoticecd +"' />";
    	
    	jQuery("<form action='/notice/noticedownload.do' method='post'>"+params+"</form>").appendTo('body').submit().remove();
    }
</script>
