...
public class LearningMaterialsController {
	 ...
	 * @author 김정욱
	 */
	@RequestMapping("b_learningMaterialsvue.do")
	public String b_learningMaterialsvue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".b_learningMaterialsvue");
		logger.info("   - paramMap : " + paramMap);

		logger.info("+ end " + className + ".b_learningMaterialsvue");

		return "sptins/learningMaterialsVue";
