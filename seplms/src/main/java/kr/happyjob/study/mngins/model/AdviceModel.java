...
public class AdviceModel {
	...
	private String cls_room;	//상담장소
	private String cst_ctt;		//상담내용
	private String cst_update_date;	//상담수정일자
	private String cst_yn;		//상담여부
	private String cst_delete_yn;	//상담삭제
	private String std_id;	// 학생ID
	// tb_userinfo
	private String std_nm; 	//학생명
	// tb_lec
	private String lec_nm;		//수강강의명
	private String ins_nm;		//수강강의명
	private String ins_id;		//수강강의명
	...
	public String getCst_yn() {
		return cst_yn;
	}
	public void setCst_yn(String cst_yn) {
		this.cst_yn = cst_yn;
	}
	public String getCst_delete_yn() {
		return cst_delete_yn;
	}
	public void setCst_delete_yn(String cst_delete_yn) {
		this.cst_delete_yn = cst_delete_yn;
	}
